<?php
/*
    Plugin Name: Emoson Components
    Plugin URI: https://themeforest.net/gcodesign/
    Description: A collection of features, widgets and more components for Emoson theme.
    Version: 1.0.0
    Author: GcoDesign Team
    Author URI: https://gcodesign.com/wordpress-plugins/
    Text Domain: emoson-components
*/
